  ...
  setupPanResponder = () => {
    ...
    this.panResponder = PanResponder.create({
      ...
      onPanResponderGrant: ({ nativeEvent }) => {
        ...
        this.offsetX = pageX - locationX;
        this.offsetY = pageY - locationY;
      ...
      onPanResponderMove: ({ nativeEvent: { pageX, pageY } }) => {
        const point = scaled({ locationX: pageX - this.offsetX, locationY: pageY - this.offsetY });
...
export default class NoGlSketch extends Sketch {
